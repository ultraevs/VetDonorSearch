        ...
        <div className={styles.advice_item}>
          ...
          <div className={styles.item_text}>
            <p>
              ...
              dignissim neque. Sed diam morbi leo blandit nisl mauris dignissim
              faucibus quis. Commodo vestibulum nulla nunc magnis. Lectus
              faucibus suspendisse auctor sed.
            </p>
          </div>
        </div>
        <div className={styles.advice_item}>
